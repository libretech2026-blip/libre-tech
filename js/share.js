  ...
  function networks(payload) {
    ...
    return [
      ...
      },
      {
        ...
        icon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.1 10.13 24v-8.44H7.08v-3.49h3.05V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.96h-1.51c-1.49 0-1.96.93-1.96 1.89v2.26h3.33l-.53 3.49h-2.8V24C19.61 23.1 24 18.1 24 12.07z"/></svg>'
      },
      {
        key: 'telegram', label: 'Telegram', color: '#229ED9',
        href: 'https://t.me/share/url?url=' + u + '&text=' + encodeURIComponent(payload.text),
        icon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.94 24c6.6 0 11.95-5.37 11.95-12S18.54 0 11.94 0 0 5.37 0 12s5.35 12 11.94 12zm5.4-16.9-1.9 9.02c-.14.64-.52.8-1.05.5l-2.9-2.15-1.4 1.36c-.16.16-.29.29-.58.29l.2-2.96 5.37-4.87c.24-.2-.05-.32-.36-.12l-6.63 4.2-2.86-.9c-.62-.2-.63-.62.13-.92l11.17-4.34c.52-.19.97.12.8.9z"/></svg>'
      },
      {
        key: 'x', label: 'X', color: '#0f1419',
        href: 'https://twitter.com/intent/tweet?text=' + encodeURIComponent(payload.text) + '&url=' + u,
        icon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.9 2H22l-7.4 8.46L23 22h-6.5l-5.1-6.66L5.6 22H2.5l7.9-9.04L1.6 2h6.66l4.6 6.09L18.9 2zm-1.14 18.2h1.72L7.4 3.7H5.56L17.76 20.2z"/></svg>'
      },
      {
        key: 'email', label: 'Correo', color: '#6e6e73',
        href: 'mailto:?subject=' + encodeURIComponent(payload.title) + '&body=' + t,
        icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><polyline points="22,6 12,13 2,6"/></svg>'
      }
    ];
  }
